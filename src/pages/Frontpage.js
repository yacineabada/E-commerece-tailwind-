      ...
      featured: [
        {
          ...
          href: "#",
          imageSrc:
            "https://media.istockphoto.com/photos/cute-stylish-children-picture-id537307742?k=20&m=537307742&s=612x612&w=0&h=sSAkRQcSU-amON0PHyayG1Fv3GFO5oJxcUApycUszVI=",
          imageAlt:
            "Models sitting back to back, wearing Basic Tee in black and bone.",
        },
        {
          ...
          href: "#",
          imageSrc:
            "https://image.made-in-china.com/2f0j00aTPRvDldIEqu/New-Style-Soft-Cotton-Children-Clothes-Fashion-Flower-Leisure-Baby-Dress.jpg",
          imageAlt:
            "Close up of Basic Tee fall bundle with off-white, ochre, olive, and black tees.",
        },
      ],
...
export default function Frontpage() {
  ...
  return (
    <>
      <Slider aftah={toggle} setAftah={setToggle} />
      <div className="bg-white">
        ...
        <header className="relative overflow-hidden">
          ...
          <nav
            aria-label="Top"
            className="relative z-20 bg-slate-200 bg-opacity-90 backdrop-blur-xl backdrop-filter"
          >
            ...
            <div className="relative mx-auto max-w-7xl px-4 sm:static sm:px-6 lg:px-8">
              ...
              <div>
                <div className="mt-10">
                  ...
                  <a
                    href="#"
                    className="inline-block rounded-md border border-transparent bg-red-600 py-3 px-8 text-center font-medium text-white hover:bg-indigo-700"
                  >
                    Shop Collection
                  </a>
                </div>
